...
def main():
    ...
    parser.add_argument('--resume_weights_only', action='store_true', help='specify this argument to restore only the weights (w/o training states)')
    ...
    # parser.add_argument('--fme_dir', default='000000')
    ...
    # config.res_dir = config.get('res_dir') or os.path.join(args.exp_dir, config.trial_name, 'res')
    ...
    config.res_dir = config.exp_dir  # os.path.join(config.exp_dir, config.name)
